...
A convincing but false stock brief can send Lucy to the wrong supplier or conceal a shortage. The lesson teaches students to inspect authoritative fixture data and the limits of prose checks before any purchase tool exists.
